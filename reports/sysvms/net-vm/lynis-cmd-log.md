[ghaf@net-vm:~]$ sudo lynis audit system
...
------------------------------------
  ...
  - Running 'systemd-analyze security'
      ...
      --------------------------------
    - 3proxy.service (value=8.2)                              [ EXPOSED ]
    - NetworkManager-dispatcher.service (value=9.6)           [ UNSAFE ]
    ...
    - ghafFetchUrl.service (value=9.2)                        [ UNSAFE ]
    - givc-dbusproxy-system.service (value=9.2)               [ UNSAFE ]
    - givc-net-vm.service (value=9.6)                         [ UNSAFE ]
    - msFetchUrl.service (value=9.2)                          [ UNSAFE ]
    - nix-daemon.service (value=9.6)                          [ UNSAFE ]
    - nw-packet-forwarder.service (value=6.2)                 [ MEDIUM ]
    ...
    - smcroute.service (value=8.7)                            [ EXPOSED ]
    ...
    - wpa_supplicant.service (value=4.5)                      [ PROTECTED ]
...
------------------------------------
  ...
  [WARNING]: Test HTTP-6622 had a long execution: 130.291927 seconds
...
------------------------------------
  - Comparing sysctl key pairs with scan profile
    ...
    - net.ipv4.conf.all.mc_forwarding (exp: 0)                [ DIFFERENT ]
